 ...
 * @LastEditors: Tao
 * @LastEditTime: 2023-04-13 20:42:22
 * @Description: 
...
int main() {
    ...
    for (int i = 0; i < 23; i++){
        ...
        average_update_hwc.push_back(average_ht.count()/double(pow(10, 6)));
        cout << "average_update_hwc: " << endl;
        cout << average_update_hwc[i] << endl;
        average_update_sc7.push_back(average_sc7.count()/double(pow(10, 6)));
        cout << "average_update_sc7: " << endl;
        cout << average_update_sc7[i] << endl;
        average_update_sc10.push_back(average_sc10.count()/double(pow(10, 6)));
        cout << "average_update_sc10: " << endl;
        cout << average_update_sc10[i] << endl;
        average_update_sc20.push_back(average_sc20.count()/double(pow(10, 6)));
