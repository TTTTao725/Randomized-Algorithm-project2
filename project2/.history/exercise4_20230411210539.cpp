...
private:
    ...
    unsigned int random_odd(); //* random odd integer generator
...
HashTable::HashTable(int n = pow(2,10)): TABLE_SIZE(n), table(new vector<key_value_pair>[n]) {
...
unsigned int HashTable::random_odd(){
